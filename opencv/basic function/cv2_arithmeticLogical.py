...
# 영상 읽기
img1 = cv2.imread("../input/img1.jpg", cv2.IMREAD_UNCHANGED)
img2 = cv2.imread("../input/img2.jpg", cv2.IMREAD_UNCHANGED)
img3 = cv2.imread("../input/img3.jpg", cv2.IMREAD_UNCHANGED)
img4 = cv2.imread("../input/img4.jpg", cv2.IMREAD_UNCHANGED)
img5 = cv2.imread("../input/img5.jpg", cv2.IMREAD_GRAYSCALE)
